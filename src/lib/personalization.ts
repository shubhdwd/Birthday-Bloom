...
const HERO_SUBTITLES: Record<Relationship, string> = {
  ...
  mother: "Because mothers deserve all the love 🌸",
  father: "For the hero of our family 💜",
...
const CAT_DIALOGUES: Record<Relationship, CatDialogueSet> = {
  ...
  "best-friend": {
    hero: "Best friends create the most beautiful memories 🥺",
  ...
  girlfriend: {
    hero: "Someone clearly put a lot of love into this 💖",
  ...
  boyfriend: {
    hero: "I think somebody spent hours making this surprise ✨",
  ...
  sister: {
    hero: "Sisters make life brighter ✨",
  ...
  brother: {
    hero: "Looks like birthday chaos is about to begin 🎉",
  ...
  mother: {
    hero: "Mothers deserve all the flowers in the world 🌸",
    gameStart: "Made with endless love and gratitude 💖",
    gameChase: "A little fun before the big surprise!",
    giftCaught: "Wrapped with all the love in the world 💕",
    letterReveal: "Words from the heart just for you ✨",
    memories: "Thank you for all these beautiful memories 🌸",
    final: "We love you so much 💖",
  },
  father: {
    hero: "Some heroes are simply called Dad 💜",
    gameStart: "Made with endless love and respect 🌟",
    gameChase: "A little challenge for you!",
    giftCaught: "Wrapped with gratitude and love 💪",
    letterReveal: "Words from the heart just for you ✨",
    memories: "Thank you for guiding us always 💜",
    final: "We love you so much 🌟",
  },
  partner: {
